========================================================================
    ACTIVEX CONTROL DLL : ieosgearth Project Overview
========================================================================

ControlWizard has created this project for your ieosgearth ActiveX Control
...
that make up your ieosgearth ActiveX Control DLL.
...
ieosgearth.ico
    ...
    is included by the main resource file ieosgearth.rc.

/////////////////////////////////////////////////////////////////////////////
CosgearthCtrl control:

osgearthCtrl.h
    This file contains the declaration of the CosgearthCtrl C++ class.

osgearthCtrl.cpp
    This file contains the implementation of the CosgearthCtrl C++ class.

osgearthPpg.h
    This file contains the declaration of the CosgearthPropPage C++ class.

osgearthPpg.cpp
    This file contains the implementation of the CosgearthPropPage C++ class.

CosgearthCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CosgearthCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file ieosgearth.rc.
...
stdafx.h, stdafx.cpp
    ...
    named ieosgearth.pch and a precompiled types (PCT) file named stdafx.obj.
