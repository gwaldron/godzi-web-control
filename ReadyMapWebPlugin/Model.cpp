#include <ReadyMapWebPlugin/Model>
...
bool RemoveModelCommand::operator ()(ReadyMapWebPlugin::MapControl *map)
{   
...
bool UpdateModelCommand::operator ()(ReadyMapWebPlugin::MapControl *map)
{
    //Find the model
